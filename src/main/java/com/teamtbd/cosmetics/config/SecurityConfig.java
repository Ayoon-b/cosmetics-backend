...
//			.authenticationEntryPoint(new LoginUrlAuthenticationEntryPoint("/login"));
	...
	@Autowired
	static public ClientRegistrationRepository clientRegistrationRepository(
	...
	private static ClientRegistration getRegistration(OAuth2ClientProperties clientProperties, String client) {
